...
type ExtraModuleSeed = { id: string; title: string; section: string; singular?: string; icon?: string; description?: string }

function makeSimpleModule(seed: ExtraModuleSeed): ModuleDefinition {
  return {
    id: seed.id,
    title: seed.title,
    singular: seed.singular ?? 'registro',
    section: seed.section,
    icon: seed.icon ?? '⚙',
    description: seed.description ?? `Gerencie ${seed.title.toLowerCase()} no módulo de ${seed.section.toLowerCase()}.`,
    benefits: ['Cadastro padronizado', 'Busca e filtros', 'Permissões por grupo', 'Impressão e exportação'],
    primaryField: 'nome',
...
const extraModules: ModuleDefinition[] = [
  { id: 'cadastros-tipos-contatos', title: 'Tipos de contatos', section: 'Cadastros', singular: 'tipo de contato', icon: '☎', description: 'Classifique os contatos utilizados nos cadastros.' },
  { id: 'cadastros-tipos-enderecos', title: 'Tipos de endereços', section: 'Cadastros', singular: 'tipo de endereço', icon: '⌖', description: 'Padronize os tipos de endereços utilizados nos cadastros.' },
  { id: 'cadastros-campos-extras', title: 'Campos extras', section: 'Cadastros', singular: 'campo extra', icon: '✚' },
  { id: 'itens-etiquetas', title: 'Etiquetas', section: 'Itens', singular: 'etiqueta', icon: '◆' },
  { id: 'itens-valores-venda', title: 'Valores de venda', section: 'Itens', singular: 'valor de venda', icon: '$' },
  { id: 'itens-grupos-produtos', title: 'Grupos de produtos', section: 'Itens', singular: 'grupo de produto', icon: '▥' },
  { id: 'itens-unidades-produtos', title: 'Unidades de produtos', section: 'Itens', singular: 'unidade de produto', icon: '⚗' },
  { id: 'itens-campos-extras', title: 'Campos extras', section: 'Itens', singular: 'campo extra', icon: '✚' },
  { id: 'orcamentos-produtos', title: 'Orçamentos de produtos', section: 'Orçamentos', singular: 'orçamento de produto', icon: '▧' },
  { id: 'orcamentos-servicos', title: 'Orçamentos de serviços', section: 'Orçamentos', singular: 'orçamento de serviço', icon: '▧' },
  { id: 'orcamentos-situacoes', title: 'Situações de orçamentos', section: 'Orçamentos', singular: 'situação', icon: '≣' },
  { id: 'orcamentos-campos-extras', title: 'Campos extras', section: 'Orçamentos', singular: 'campo extra', icon: '✚' },
  { id: 'orcamentos-modelo-email', title: 'Modelo de e-mail', section: 'Orçamentos', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'orcamentos-configuracoes', title: 'Configurações', section: 'Orçamentos', singular: 'configuração', icon: '⚙' },
  { id: 'vendas-produtos', title: 'Vendas de produtos', section: 'Vendas', singular: 'venda de produto', icon: '▰' },
  { id: 'vendas-servicos', title: 'Vendas de serviços', section: 'Vendas', singular: 'venda de serviço', icon: '▰' },
  { id: 'vendas-situacoes', title: 'Situações de vendas', section: 'Vendas', singular: 'situação', icon: '≣' },
  { id: 'vendas-canais', title: 'Canais', section: 'Vendas', singular: 'canal', icon: '◉' },
  { id: 'vendas-campos-extras', title: 'Campos extras', section: 'Vendas', singular: 'campo extra', icon: '✚' },
  { id: 'vendas-modelo-email', title: 'Modelo de e-mail', section: 'Vendas', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'vendas-balancas', title: 'Balanças', section: 'Vendas', singular: 'balança', icon: '⚖' },
  { id: 'vendas-configuracoes', title: 'Configurações', section: 'Vendas', singular: 'configuração', icon: '⚙' },
  { id: 'os-gerenciar', title: 'Gerenciar O.S.', section: 'Ordens de serviços', singular: 'ordem de serviço', icon: '⚒' },
  { id: 'os-painel', title: 'Painel da O.S.', section: 'Ordens de serviços', singular: 'painel', icon: '◔' },
  { id: 'os-situacoes', title: 'Situações da O.S.', section: 'Ordens de serviços', singular: 'situação', icon: '≣' },
  { id: 'os-campos-extras', title: 'Campos extras', section: 'Ordens de serviços', singular: 'campo extra', icon: '✚' },
  { id: 'os-modelos-email', title: 'Modelos de e-mail', section: 'Ordens de serviços', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'os-configuracoes', title: 'Configurações', section: 'Ordens de serviços', singular: 'configuração', icon: '⚙' },
  { id: 'compras-produtos', title: 'Compras de produtos', section: 'Compras', singular: 'compra de produto', icon: '◫' },
  { id: 'compras-servicos', title: 'Compras de serviços', section: 'Compras', singular: 'compra de serviço', icon: '◫' },
  { id: 'compras-situacoes', title: 'Situações de compras', section: 'Compras', singular: 'situação', icon: '≣' },
  { id: 'compras-campos-extras', title: 'Campos extras', section: 'Compras', singular: 'campo extra', icon: '✚' },
  { id: 'compras-modelo-email', title: 'Modelo de e-mail', section: 'Compras', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'compras-configuracoes', title: 'Configurações', section: 'Compras', singular: 'configuração', icon: '⚙' },
  { id: 'financeiro-dre', title: 'DRE gerencial', section: 'Financeiro', singular: 'DRE', icon: '↗' },
  { id: 'financeiro-fluxo-caixa', title: 'Fluxo de caixa', section: 'Financeiro', singular: 'fluxo de caixa', icon: '↗' },
  { id: 'boletos-gerenciar', title: 'Gerenciar boletos', section: 'Financeiro', singular: 'boleto', icon: '▥' },
  { id: 'boletos-exportar-remessa', title: 'Exportar remessa', section: 'Financeiro', singular: 'remessa', icon: '⇣' },
  { id: 'boletos-importar-retorno', title: 'Importar retorno', section: 'Financeiro', singular: 'retorno', icon: '⇡' },
  { id: 'financeiro-caixas', title: 'Caixas', section: 'Financeiro', singular: 'caixa', icon: '◫' },
  { id: 'financeiro-plano-contas', title: 'Plano de contas', section: 'Financeiro', singular: 'conta', icon: '≣' },
  { id: 'financeiro-situacoes', title: 'Situações financeiras', section: 'Financeiro', singular: 'situação', icon: '≣' },
  { id: 'financeiro-centros-custos', title: 'Centros de custos', section: 'Financeiro', singular: 'centro de custo', icon: '◎' },
  { id: 'financeiro-conciliacao-bancaria', title: 'Conciliação bancária', section: 'Financeiro', singular: 'conciliação', icon: '✓' },
  { id: 'financeiro-transferencias', title: 'Transferências', section: 'Financeiro', singular: 'transferência', icon: '⇄' },
  { id: 'financeiro-campos-extras', title: 'Campos extras', section: 'Financeiro', singular: 'campo extra', icon: '✚' },
  { id: 'financeiro-modelos-email', title: 'Modelos de e-mails', section: 'Financeiro', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'financeiro-tabelas-rateios', title: 'Tabelas de rateios', section: 'Financeiro', singular: 'tabela de rateio', icon: '▤' },
  { id: 'financeiro-configuracoes', title: 'Configurações', section: 'Financeiro', singular: 'configuração', icon: '⚙' },
  { id: 'fiscal-notas-produtos', title: 'Notas de produtos', section: 'Fiscal', singular: 'nota de produto', icon: '⌘' },
  { id: 'fiscal-notas-servicos', title: 'Notas de serviços', section: 'Fiscal', singular: 'nota de serviço', icon: '⌘' },
  { id: 'fiscal-notas-consumidor', title: 'Notas do consumidor', section: 'Fiscal', singular: 'nota de consumidor', icon: '⌘' },
  { id: 'fiscal-notas-compras', title: 'Notas de compras', section: 'Fiscal', singular: 'nota de compra', icon: '⌘' },
  { id: 'fiscal-importar-xml', title: 'Importar XML', section: 'Fiscal', singular: 'importação XML', icon: '↻' },
  { id: 'fiscal-certificado-digital', title: 'Certificado digital', section: 'Fiscal', singular: 'certificado digital', icon: '◇' },
  { id: 'fiscal-naturezas-operacoes', title: 'Naturezas de operações', section: 'Fiscal', singular: 'natureza de operação', icon: '◎' },
  { id: 'fiscal-tributacoes', title: 'Tributações', section: 'Fiscal', singular: 'tributação', icon: '$' },
  { id: 'fiscal-atividades-servicos', title: 'Atividades de serviços', section: 'Fiscal', singular: 'atividade de serviço', icon: '⚒' },
  { id: 'fiscal-modelos-email', title: 'Modelos de e-mails', section: 'Fiscal', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'fiscal-intermediadores', title: 'Intermediadores', section: 'Fiscal', singular: 'intermediador', icon: '⇄' },
  { id: 'fiscal-configuracoes', title: 'Configurações', section: 'Fiscal', singular: 'configuração', icon: '⚙' },
  { id: 'contratos-servicos', title: 'Contratos de serviços', section: 'Contratos', singular: 'contrato de serviço', icon: '▱' },
  { id: 'contratos-locacoes', title: 'Locações', section: 'Contratos', singular: 'locação', icon: '▱' },
  { id: 'contratos-situacoes', title: 'Situações de contratos', section: 'Contratos', singular: 'situação', icon: '≣' },
  { id: 'contratos-campos-extras', title: 'Campos extras', section: 'Contratos', singular: 'campo extra', icon: '✚' },
  { id: 'contratos-modelos-email', title: 'Modelos de e-mails', section: 'Contratos', singular: 'modelo de e-mail', icon: '✉' },
  { id: 'contratos-configuracoes', title: 'Configurações', section: 'Contratos', singular: 'configuração', icon: '⚙' },
  { id: 'relatorios-cadastros', title: 'Relatórios de cadastros', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-vendas', title: 'Relatórios de vendas', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-ordens-servicos', title: 'Relatórios de ordens de serviços', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-estoque', title: 'Relatórios de estoque', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-financeiro', title: 'Relatórios financeiros', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-contratos', title: 'Relatórios de contratos', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-fiscal', title: 'Relatórios fiscais', section: 'Relatórios', singular: 'relatório', icon: '▩' },
  { id: 'relatorios-logs-sistema', title: 'Logs do sistema', section: 'Relatórios', singular: 'log', icon: '▩' },
].map(makeSimpleModule)

const uniqueModuleMap = new Map<string, ModuleDefinition>()
for (const module of [...modules, ...extraModules]) uniqueModuleMap.set(module.id, module)
